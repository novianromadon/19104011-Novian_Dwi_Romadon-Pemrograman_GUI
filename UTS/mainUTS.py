...
class Ui_MainWindow(object):
    ...
    def setupUi(self, MainWindow):
        ...
        self.btnTambah.clicked.connect(self.klikBtnTambah)
        ...
        self.btnClear.clicked.connect(self.klikBtnClear)
        ...
        self.btnHapus.clicked.connect(self.klikBtnHapus)

        # Output Data
        self.listWidget = QtWidgets.QListWidget(self.centralwidget)
        self.listWidget.setGeometry(QtCore.QRect(40, 70, 421, 192))
    ...
    def klikBtnTambah(self):
        self.listWidget.addItem(
           self.inputNIM.text()  + '   ' + self.inputNama.text() + '   ' + self.inputJurusan.text()  + '   ' + self.inputNoTelp.text())
    
    # Fungsi Button Clear
    def klikBtnClear(self):
        self.inputNIM.setText('')
        self.inputNama.setText('')
        self.inputJurusan.setText('')
        self.inputNoTelp.setText('')

    # Fungsi Button Hapus
    def klikBtnHapus(self):
