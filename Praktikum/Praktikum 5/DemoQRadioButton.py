...
class MainForm(QWidget):
    ...
    def setupUi(self):
      ...
      # Membuat label Bilangan pertama dan LineEditnya
      self.label1 = QLabel() 
      self.label1.setText('Bilangan pertama') 
      self.numberEdit1 = QLineEdit() 

      # Membuat label Bilangan kedua dan LineEditnya
      self.label2 = QLabel() 
      ...
      # Radio Button Tambah, Kurang, Kali, Bagi
      ...
      # Membuat Label Hasil penjumlahan
      self.resultLabel = QLabel('<b>Hasil penjumlahan: </b>') 
       
      # Membuat PushButton Hitung
      self.calculateButton = QPushButton('Hitung')

      # Semua digabung menggunakan layout vertikal
      layout = QVBoxLayout() 
      ...
      # Setting output ketika memilih perhitungan
